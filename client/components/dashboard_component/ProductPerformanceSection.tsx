...
const ProductPerformanceSection = () => {
  return (
    <div className="lg:col-span-3 pt-5 flex flex-col rounded-xl border-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-lg w-full  h-[600px] lg:h-[680px] ">
