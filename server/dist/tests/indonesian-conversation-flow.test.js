...
class ConversationFlowTester {
    ...
    resetConversation() {
        return __awaiter(this, void 0, void 0, function* () {
            yield conversationState_model_1.default.deleteOne({ phoneNumber: this.testPhoneNumber });
    ...
    sendMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            const ts = Date.now();
            const result = yield this.conversationManager.processMessage(message, this.testPhoneNumber, `test_${ts}`, new mongoose_2.Types.ObjectId().toString());
            return {
    ...
    runScenario(scenario) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const step of scenario.steps) {
                try {
                    const result = yield this.sendMessage(step.input);
                    const failures = [];
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const scenario of testScenarios) {
                const result = yield tester.runScenario(scenario);
                if (result.passed) {
                    totalPassed++;
                }
                else {
                ...
                yield tester.resetConversation();
            }
            console.log("\n" + "=".repeat(60));
